...
export class AuthGuard implements CanActivate {
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        console.log("no inicio correctamente sesion )="); console.log(state.url);
        return false;
    }
}
    ...
    /*
            canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
            canActivate:  Interfaz de que una clase puede implementar para ser un 
                            guardia de decidir si una ruta puede ser activado.
